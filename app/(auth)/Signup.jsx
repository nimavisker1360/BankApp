        ...
        <View className="flex-1 px-5">
          ...
          <View className="items-center mt-24 mb-12">
            ...
            <Text className="text-center text-[#7D7D7D] mt-4">
              Register with your phone number, Google,
            </Text>
            <Text className="text-center text-[#7D7D7D]">or Facebook</Text>
          </View>

          <View className="w-full mb-28">
            <TextInput
              className="w-full p-4 text-base border border-gray-200 rounded-md bg-white"
