    ...
    <SafeAreaView className="bg-primary w-full h-full justify-center">
      ...
      >
        ...
        <View className="mt-6 rounded-3xl border-2 border-[#E7E7E7] flex-row items-center w-full h-[56px] px-4">
          ...
          <TextInput className="flex-1 font-pmedium ml-2" placeholder="Phone number" keyboardType="number-pad" />
        </View>

        {/* Email Input */}
        <View className="mt-6 rounded-3xl border-2 border-[#E7E7E7] flex-row items-center w-full h-[56px] px-4">
          <Image className="w-6 h-6" source={icons.mail} resizeMode="contain" />
          <TextInput className="flex-1 font-pmedium ml-2" placeholder="Email Address" keyboardType="email-address" />
        </View>

        {/* Password Input */}
        <View className="mt-6 rounded-3xl border-2 border-[#E7E7E7] flex-row items-center w-full h-[56px] px-4">
          <Image className="w-6 h-6" source={icons.lock} resizeMode="contain" />
          <TextInput className="flex-1 font-pmedium ml-2" placeholder="Password" secureTextEntry={!showPassword} />
        ...
        <View className="mt-6 rounded-3xl border-2 border-[#E7E7E7] flex-row items-center w-full h-[56px] px-4">
          ...
          <TextInput className="flex-1 font-pmedium ml-2" placeholder="First Name" />
        </View>

        {/* Last Name */}
        <View className="mt-6 rounded-3xl border-2 border-[#E7E7E7] flex-row items-center w-full h-[56px] px-4">
          <Image className="w-6 h-6" source={icons.user} resizeMode="contain" />
          <TextInput className="flex-1 font-pmedium ml-2" placeholder="Last Name" />
        </View>

        {/* Date Picker */}
        <TouchableOpacity onPress={() => setShowDatePicker(true)} className="mt-6 rounded-3xl border-2 border-[#E7E7E7] flex-row items-center w-full h-[56px] px-4">
          <Image className="w-6 h-6" source={icons.calendar} resizeMode="contain" />
