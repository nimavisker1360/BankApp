      ...
      >
        ...
        <View className="w-full p-3">
          ...
          <View className="flex-row justify-between gap-3 mt-1">
            <TouchableOpacity className="flex-1 p-2 flex-row bg-[#3E92CC] rounded-3xl justify-center items-center">
              <Image
        ...
        <View className="flex-row justify-around items-center bg-[#00EB97] w-[95%] h-[120px] mt-4 rounded-[8px]">
          <View className="mr-0">
            <Image
              className="w-[112px] h-[83px]"
              source={images.rafiki}
              resizeMode="contain"
            />
          </View>

          <View className="">
            <Text className="text-[21px] text-white font-pregular">
              Complete your
            </Text>
            <Text className="text-[21px] text-white font-pregular">
        ...
        <View className="w-full mt-2 mb-14">
          <View className="w-full flex-row justify-between items-center p-3">
            ...
            <Link href="/Transactions" className="text-[#00EB97] font-pregular">
              See all
            </Link>
          </View>
          ...
          {transactionLog.length === 0 ? (
            ...
            transactionLog.slice(0, 4).map((item,index) => (
              <TouchableOpacity
              key={item.id || index} 
